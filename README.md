...
resources.md           ← Curated links, tools, and references (grows over time)
agent-config.md        ← AI tooling setup and configuration notes
weeks/
  week-01/             ← Week 1 deliverables
    study-plan.md      ← Weekly learning objectives and schedule
    log-session-01.md  ← Agent-assisted session log (substantive, not transcript)
    retrospective.md   ← What worked, what didn't, what I'd change
  week-02/             ← (coming soon)
  ...
prompts/               ← Reusable prompt templates and iterations
demos/                 ← Interactive artifacts and project demos
```
...
| Week | Status | Focus |
|------|--------|-------|
| Week 1 | In Progress | Foundation — AI tooling setup, first agent-assisted session, repo structure |

## What's Next

- Week 2: [TBD — will update after Week 1 retrospective]
